function EZSlots(id,useroptions){
	...
	this.symbols = options.symbols ? options.symbols : {};
...
function getFeedData () {
	...
	// let url = 'https://belive.multitvsolution.com:3600/userslist/5f450bb019475-login/0/0';
	fetch ('https://belive.multitvsolution.com:3600/userslist/5f450bb019475-login/0/0')
	  .then (response => {
